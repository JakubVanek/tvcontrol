...
{
	public class OSDshow : IntegerCommand
    {
        public const int OSDoff = 0x0;
        public const int OSDon = 0x1;

		public override string Name   { get; }	= "kl";
		public override int UpLimit   { get; }	= 0x1;
		public override int DownLimit { get; }	= 0x0;

		public OSDshow(){}
		public OSDshow(int value) : base(value) {}
    }
}
